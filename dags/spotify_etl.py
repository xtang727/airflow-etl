...
def check_if_valid_data(df: pd.DataFrame) -> bool:
    ...
    for timestamp in timestamps:
        if datetime.datetime.strptime(timestamp, '%Y-%m-%d') < yesterday:
            raise Exception("At least one of the returned songs are more than 24 hours old")
    return True

def run_spotify_etl():
    DATABASE_LOCATION = "sqlite:///played_tracks.sqlite"
    TOKEN = "BQCRNphRtzVDeemn6w7qpxu2gXXgiKkfQOcjQ1B-ARiEc0KJGOe0RGTk5C7U8RvYOhaPkEzugfufdkOtu_FADxqUkjY3JV2iPKY-U1YTGyB5qTFEeTH1gxPibUrtG7h8OpmMGC_UoPillPXcSmIGvD50YRR0udhTDo5Mk9Jv"
